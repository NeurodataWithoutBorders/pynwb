...
class ElectrodeGroupConstructor(unittest.TestCase):
    def test_init(self):
        ...
        group = ElectrodeGroup(  # noqa: F405
            'elec1', 'a test source', 'electrode description', 'electrode location', dev1)
...
class ClusteringConstructor(unittest.TestCase):
    def test_init(self):
        ...
        cc = Clustering('test_cc', 'description', num, peak_over_rms, times)  # noqa: F405
...
class ClusterWaveformsConstructor(unittest.TestCase):
    def test_init(self):
        ...
        cw = ClusterWaveforms('test_cw', cc, 'filtering', means, stdevs)  # noqa: F405
...
class FeatureExtractionConstructor(unittest.TestCase):
    ...
    def test_invalid_init_mismatched_event_times(self):
        ...
        self.assertRaises(
            TypeError, FeatureExtraction, 'test_fe', electrodes, description, event_times, features)   # noqa: F405
    ...
    def test_invalid_init_mismatched_electrodes(self):
        ...
        description = ['desc1', 'desc2', 'desc3']
        features = [[[0, 1, 2], [3, 4, 5]]]
        self.assertRaises(TypeError, FeatureExtraction, 'test_fe', electrodes,   # noqa: F405
    ...
    def test_invalid_init_mismatched_description(self):
        ...
        features = [[[0, 1, 2], [3, 4, 5]]]
        self.assertRaises(TypeError, FeatureExtraction, 'test_fe',   # noqa: F405
