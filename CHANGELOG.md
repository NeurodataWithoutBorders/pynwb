...
- `mock_ElectricalSeries`. Make number of electrodes betweeen data an electrode region agree when explicitly passing data @h-mayorquin [#2019](https://github.com/NeurodataWithoutBorders/pynwb/pull/2019)
