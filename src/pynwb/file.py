...
class NWBFile(MultiContainerInterface):
    ...
    @docval({'name': 'source', 'type': str, 'doc': 'the source of the data'},
            ...
            {'name': 'electrodes', 'type': (ElectrodeTable, Iterable),
    ...
    def __init__(self, **kwargs):
        ...
        self.electrode_groups = getargs('ec_electrode_groups', kwargs)
...
def ElectrodeTable(name='electrodes',
    ...
    return _tablefunc(name, description,
                      ['x', 'y', 'z', 'imp', 'location', 'filtering', 'description2', 'group', 'group_name'],
                      source)
