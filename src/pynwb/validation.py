...
from pynwb import CORE_NAMESPACE, get_type_map
...
def validate_cli():
    ...
    installed_core_version = get_type_map().namespace_catalog.get_namespace("core")["version"]
    parser = ArgumentParser(
        description="Validate one or more NWB files",
    ...
    parser.add_argument("paths", type=str, nargs="+", help="NWB file path(s)")
    ...
    feature_parser.add_argument(
        ...
        action="store_true",
        help=f"Use the namespace installed with PyNWB ({installed_core_version}) instead of the cached namespace(s).",
    )
