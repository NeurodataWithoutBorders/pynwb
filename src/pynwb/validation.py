...
As of PyNWB 3.0, the validate function and the validate CLI tool validate an NWB file or an open IO object
in the same way.
...
@docval(
    ...
    },
    {
        "name": "namespace",
        "type": str,
        "doc": ("A specific namespace to validate against. As of PyNWB 3.0, if None and use_cached_namespaces=True, "
                "this function will validate against all namespaces in the file except for dependent namespaces."),
        "default": None,
    },
    {
    ...
    },
    {
        "name": "io",
        "type": HDMFIO,
        "doc": "An open IO to an NWB file. Deprecated in PyNWB 3.0 in favor of 'paths'.",
        "default": None,
    },
...
def validate(**kwargs):
    ...
    if "io" in kwargs:
        warnings.warn("The 'io' argument is deprecated. Please use 'paths' instead.", DeprecationWarning, stacklevel=3)
