...
Throughout the NWB schema, there are multiple :py:class:`~pynwb.core.NWBDataInterface` specifications that include one or more or zero
or more of a certain neurodata type. For example, the :py:class:`~pynwb.ecephys.LFP` neurodata type contains one or more :py:class:`~pynwb.ecephys.ElectricalSeries`.
...
After you have created your custom API, you can publish your extension following the instructions in :ref:`extension-documentation` and :ref:`extension-publishing`.
